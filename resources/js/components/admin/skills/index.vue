<script setup>
    ...
    const updateSkil = async() => {
        ...
        .then(()=>{
            ...
            toast.fire({
                icon: 'success',
                title: 'Skill update sucessfully'
            })
        }).cath(error=>{
            console.log(error)
        })
    ...
    const deleteSkill = (id) => {
        Swal.fire({
            ...
            if (result.value) {
                axios.delete('/api/delete_skill/'+id)
                .then(()=>{
                    Swal.fire(
                        'Delete',
           ...
           <section class="skills section" id="skills">
                    ...
                    <div class="modal main__modal " :class="{ show: showModal }">
                        <div class="modal__content">
                            ...
                            <form @submit.prevent="editMode ? updateSkil() : createSkill()">
