...
const changePhoto = (e) => {
    ...
    const updateTestomonial = async () => {
        await axios.put(`/api/update_testimonial/${form.value.id}`, form.value)
        .then(response => {
            router.push({ name: 'projectAdminTestimonials' })
            toast.fire({
                icon: 'success',
            ...
            <section class="about section" id="testimonial">
                <div class="about_container">
                    <div class="titlebar">
                        ...
                        <div class="titlebar_item">
                            <div class="btn btn-secondary" @click="updateTestomonial(props.id)">
                                Update Testimonial
                            </div>
                        </div>
                    </div>
